...
public class ProductCatalogAPIConfig {
    ...
    public OAuth2ClientHttpRequestInterceptor productCatalogAPIClientInterceptor(ProductCatalogIntegrationProperties properties, OAuth2AuthorizedClientManager manager) {
    ...
    private Authentication generatePrincipal(@NotBlank String principalName) {
