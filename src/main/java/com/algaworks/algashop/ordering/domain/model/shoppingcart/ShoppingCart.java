...
public class ShoppingCart implements AggregateRoot<ShoppingCartId> {
    ...
    public ShoppingCart(ShoppingCartId id, Long version, CustomerId customerId, Money totalAmount, Quantity totalItems, OffsetDateTime createdAt, Set<ShoppingCartItem> items) {
        this.setId(id);
