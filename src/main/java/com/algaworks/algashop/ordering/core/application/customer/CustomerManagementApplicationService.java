...
import com.algaworks.algashop.ordering.core.ports.input.customer.ForManagingCustomers;
...
public class CustomerManagementApplicationService implements ForManagingCustomers {
    ...
    @Transactional
    @Override
    public UUID create(UUID customerAuthenticatedUserId, CustomerInput input) {
        Objects.requireNonNull(input);
        AddressData address = input.getAddress();

        Customer customer = customerRegistration.register(
                new CustomerId(customerAuthenticatedUserId),
