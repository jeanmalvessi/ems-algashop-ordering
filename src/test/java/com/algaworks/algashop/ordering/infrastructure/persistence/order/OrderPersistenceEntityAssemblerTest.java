...
import com.algaworks.algashop.ordering.infrastructure.adapters.output.persistence.order.OrderItemPersistenceEntity;
import com.algaworks.algashop.ordering.infrastructure.adapters.output.persistence.order.OrderPersistenceEntity;
import com.algaworks.algashop.ordering.infrastructure.adapters.output.persistence.order.OrderPersistenceEntityAssembler;
...
class OrderPersistenceEntityAssemblerTest {
    ...
    void givenOrderWithItems_shouldAddToPersistenceEntity() {
        ...
        Assertions.assertThat(persistenceEntity.getItems()).hasSameSizeAs(order.items());
    }
